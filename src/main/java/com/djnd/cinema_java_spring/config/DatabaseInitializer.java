...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if (permissionCnt == 0) {
            ...
            permissionList.add(
                    new Permission("CREATE_PERMISSION", Constants.VERSION_API + "/admin/permissions",
                            PermissionMethod.POST,
                            "PERMISSIONS"));
            permissionList.add(
                    new Permission("UPDATE_PERMISSION", Constants.VERSION_API + "/admin/permissions",
                            PermissionMethod.PUT,
                            "PERMISSIONS"));
            permissionList
                    .add(new Permission("DELETE_PERMISSION", Constants.VERSION_API + "/admin/permissions/admin/{id}",
                            PermissionMethod.DELETE,
                            "PERMISSIONS"));
            permissionList.add(
                    new Permission("GET_PERMISSION", Constants.VERSION_API + "/admin/permissions{id}",
                            PermissionMethod.GET,
                            "PERMISSIONS"));
            permissionList.add(new Permission("GET_ALL_PERMISSION", Constants.VERSION_API + "/admin/permissions",
                    PermissionMethod.GET, "PERMISSIONS"));

            permissionList.add(
                    new Permission("CREATE_ROLE", Constants.VERSION_API + "/admin/roles", PermissionMethod.POST,
                            "ROLES"));
            permissionList.add(
                    new Permission("UPDATE_ROLE", Constants.VERSION_API + "/admin/roles", PermissionMethod.PUT,
                            "ROLES"));
            permissionList.add(new Permission("DELETE_ROLE", Constants.VERSION_API + "/admin/roles/admin/{id}",
                    PermissionMethod.DELETE, "ROLES"));
            permissionList.add(
                    new Permission("GET_ROLE", Constants.VERSION_API + "/admin/roles/admin/{id}", PermissionMethod.GET,
                            "ROLES"));
            permissionList.add(
                    new Permission("GET_ALL_ROLE", Constants.VERSION_API + "/admin/roles", PermissionMethod.GET,
                            "ROLES"));

            permissionList.add(
                    new Permission("CREATE_USER", Constants.VERSION_API + "/admin/users", PermissionMethod.POST,
                            "USERS"));
            permissionList.add(
                    new Permission("UPDATE_USER", Constants.VERSION_API + "/admin/users", PermissionMethod.PUT,
                            "USERS"));
            permissionList.add(new Permission("DELETE_USER", Constants.VERSION_API + "/admin/users/admin/{id}",
                    PermissionMethod.DELETE, "USERS"));
            permissionList.add(
                    new Permission("GET_USER", Constants.VERSION_API + "/admin/users/admin/{id}", PermissionMethod.GET,
                            "USERS"));
            permissionList.add(
                    new Permission("GET_ALL_USER", Constants.VERSION_API + "/admin/users", PermissionMethod.GET,
                            "USERS"));
