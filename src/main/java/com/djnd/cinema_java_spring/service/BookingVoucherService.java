...
public class BookingVoucherService {
    ...
    @Transactional
    public BookingVoucher generateBookingVoucher(Booking booking, Promotion voucher, Double discountPercent,
            BigDecimal discountAmount, BigDecimal finalTotalAmount) {
