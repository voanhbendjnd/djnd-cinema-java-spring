...
public class NotificationAsyncService {
    ...
    private void sendMailSeatMaintenanceForCustomerAlreadyHasTicket(SeatMaintenanceMailDTO seatMaintenanceMailDTO) {
        ...
        String content = springTemplateEngine.process("mail/seatMaintenanceMail", context);
        String subject = messageSource.getMessage("Seat maintenance notice", null, locale);
